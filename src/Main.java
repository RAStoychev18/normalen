...
public class Main {
    public static void main(String[] args) {
        ...
        Pharmacy pharmacy1 = new Pharmacy("bilki", 10, 3, LocalDate.now());
        Pharmacy pharmacy2 = new Pharmacy("lukcheta", 4, 99, LocalDate.now());
        Pharmacy pharmacy3 = new Pharmacy("nafta", 7, 58, LocalDate.now());
